...
import 'package:silentium_imperium_mobile/simple_demo.dart';
import 'package:silentium_imperium_mobile/simple_recorder.dart';
import 'package:silentium_imperium_mobile/sound_stream.dart';
import 'models.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  MqttCurrentConnectionState localConnectionState =
  ...
  Future<void> setup() async {
    ...
    try {
      ...
      print('EXAMPLE::client exception - $e');
      localConnectionState = MqttCurrentConnectionState.CONNECTED;
      client.disconnect();
    } on SocketException catch (e) {
      // Raised by the socket layer
      print('EXAMPLE::socket exception - $e');
      localConnectionState = MqttCurrentConnectionState.ERROR_WHEN_CONNECTING;
      client.disconnect();
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: localConnectionState != MqttCurrentConnectionState.CONNECTED
          ? Center(
              child: Column(
          ...
          : Column(
              children: [
                ElevatedButton(
                  child: Text('Press here to go to record sound'),
                  onPressed: () {
                ...
                ElevatedButton(
                  child: Text('Press here to go to simple recorder sound'),
                  onPressed: () {
                    // Navigate to second route when tapped.
                    Navigator.push(
                      context,
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => WidgetUIDemo()),
                    );
                  },
                ),
                ElevatedButton(
